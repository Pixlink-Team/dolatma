...
const CATALOG: CatalogEntry[] = [
  ...
  {
    code: "rate_limit",
    match: [/تلاش.?های ورود بیش از حد/, /ثانیه دیگر دوباره/],
    title: "تعداد تلاش ورود زیاد بوده است",
    why: "برای امنیت حساب، ورود موقتاً محدود شده است.",
    whatToDo: "تا پایان زمان اعلام‌شده صبر کنید و بعد با رمز درست دوباره وارد شوید.",
    severity: "warning",
    showModal: true,
  },
  {
  ...
  },
  {
    ...
    exact: [
      ...
      "نوع فایل برای راش تصویر مجاز نیست",
      "محتوای فایل با راش تصویر هم‌خوانی ندارد",
