...
function mapOwnerFromDb(row: any): Ownable {
  ...
  return {
    ...
    ownerMinistryId: row.owner_ministry_id ?? null,
    ownerMinistryName: row.owner_ministry_name ?? null,
    ownerOrganizationId: row.owner_organization_id ?? null,
    ownerOrganizationName: row.owner_organization_name ?? null,
