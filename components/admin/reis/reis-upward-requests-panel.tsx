  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold">درخواست‌های بالاسری</h2>
          <p className="text-sm text-muted-foreground">
            زیرمجموعه‌ها می‌توانند درخواست خود را به بالاسری بفرستند؛ اینجا همه
            درخواست‌ها دیده و پاسخ داده می‌شود.
          </p>
        </div>
